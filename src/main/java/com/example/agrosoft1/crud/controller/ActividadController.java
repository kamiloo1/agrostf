...
public class ActividadController {
    ...
    public String listar(Model model) {
        try {
            java.util.List<Actividad> actividades = actividadService.listarActividades();
            java.util.List<Cultivo> cultivos = cultivoService.listarCultivos();
            model.addAttribute("actividades", actividades != null ? actividades : new java.util.ArrayList<>());
            model.addAttribute("cultivos", cultivos != null ? cultivos : new java.util.ArrayList<>());
        } catch (Exception e) {
            org.slf4j.LoggerFactory.getLogger(ActividadController.class).error("Error al cargar actividades", e);
            model.addAttribute("actividades", new java.util.ArrayList<>());
            model.addAttribute("cultivos", new java.util.ArrayList<>());
